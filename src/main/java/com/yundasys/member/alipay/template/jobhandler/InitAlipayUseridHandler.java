...
/**
 * 
 * @Description: 初始化保存alipay用户id 
 * @author htj 
 * @date 2020年7月6日
 */
@JobHandler(value="initAlipayUseridHandler")
@Component
public class InitAlipayUseridHandler extends IJobHandler {
	...
	public ReturnT<String> execute(String param) throws Exception {
		try {
			XxlJobLogger.log("获取并保存alipay用户id任务开始执行 ....................");
			...
			long dt = (System.currentTimeMillis() - l)/(1000*60);
			XxlJobLogger.log("任务完美成功........耗时 dt = {}",dt);
		}catch (Exception e) {
	 ...
	 *@date: 2020年7月6日
	 */
	public void getAlipayUserids() throws Exception {
    	String nextUserId = "";
    	String tempId = srt.opsForValue().get(GlobalConstant.NEXT_USER_ID_KEY);
    	if(StringUtils.isNotBlank(tempId)) {
    		nextUserId = tempId;
